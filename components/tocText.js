...
export default function TOCtext(props) {
    ...
    return (
        ...
        <div className="prose max-w-none prose-lead:text-3xl prose-h1:text-6xl mb-10 dark:prose-invert">
            ...
            <p className="lead text-center">The {/*projectInfo.version*/}initial round of designs have been collected in a single click-through presentation. The table of contents below shows how the {projectInfo.frames} slides are organized.</p>
